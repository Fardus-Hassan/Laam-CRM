...
export const REPORT_VIEWS: ReportViewConfig[] = [
  ...
  { id: 'marketing', label: 'Meta Ads', description: 'Manual ad spend + attributed revenue/ROAS (Meta API later).', category: 'marketing', icon: Megaphone },
  { id: 'campaign', label: 'Campaign ROI', description: 'Per-campaign spend (manual) vs UTM revenue.', category: 'marketing', icon: Megaphone },
