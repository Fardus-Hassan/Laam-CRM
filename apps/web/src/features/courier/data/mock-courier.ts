...
let inbox: CourierInboxEvent[] = [
  { id: 'ev-1', type: 'delivered', orderId: 'ord-1', orderNumber: 'MH-8821', consignmentId: 'PH-99102', provider: 'pathao', customerName: 'Fatima Begum', message: 'Parcel delivered successfully', createdAt: '2026-07-04T09:12:00Z', isRead: false },
  { id: 'ev-2', type: 'cod_collected', orderId: 'ord-2', orderNumber: 'MH-8819', consignmentId: 'CB-99088', provider: 'carrybee', customerName: 'Karim Uddin', message: 'COD ৳2,450 collected', createdAt: '2026-07-04T08:55:00Z', isRead: false },
  ...
  { id: 'ev-4', type: 'failed', orderId: 'ord-4', orderNumber: 'MH-8802', consignmentId: 'CB-99001', provider: 'carrybee', customerName: 'Rashid Ahmed', message: 'Customer unreachable — retry scheduled', createdAt: '2026-07-04T07:10:00Z', isRead: true },
...
export function getCourierOverview(): CourierOverview {
  ...
  return {
    accounts: [
      ...
      { id: 'ca-2', provider: 'carrybee', label: 'Carrybee Main', status: 'active', isDefault: false, apiKeyMasked: 'cb_••••821', lastSyncAt: '2026-07-04T08:00:00Z', consignmentsToday: 28, successRate: 91.5 },
    ],
    rules: {
      defaultProvider: 'pathao',
      codEnabled: true,
      codChargePercent: 1,
