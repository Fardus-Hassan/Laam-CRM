...
export function FollowupWorkspaceHeader({
  lastRefreshedAt,
  isRefreshing,
  onRefresh,
  className,
  ...
  return (
    <div className={cn('flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between', className)}>
      <div className="min-w-0">
        <h2 className="text-base font-semibold tracking-tight">Customer follow-up</h2>
        <p className="mt-0.5 text-sm text-muted-foreground">
          Schedule callbacks, notes, and repeat orders for modhu & khejur buyers.
        </p>
        {refreshedLabel ? (
