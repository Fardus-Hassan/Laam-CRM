...
export const LAAM_INCENTIVE_SEED = {
  salary: {
    ...
    notes:
      'Reference salary template — editable per tenant. Attendance bonus requires full attendance (no late / early leave / unapproved absence).',
  },
  ...
  teams: [
    ...
    },
    {
      ...
      slug: 'relationship',
      description:
        'Post-delivery survey & customer follow-up (verified survey count).',
      plan: {
        name: 'Relationship surveys',
        slug: 'relationship-surveys',
        metricType: 'survey_count',
        description: 'Count verified survey completions logged for the month.',
        slabs: [
    ...
    },
    {
      ...
      slug: 'night-shift',
      description:
        '22:00–07:00 support across call / FB / Messenger / WhatsApp.',
      plan: {
        name: 'Night channel activity',
        slug: 'night-channel-activity',
        metricType: 'channel_activity',
        metricConfig: {
          channels: ['call', 'facebook_comment', 'messenger', 'whatsapp'],
        },
        slabs: [
